            ...
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                ...
                <tr className="hover:bg-gray-50">
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      ...
                      <div>
                        <div className="text-sm font-medium text-gray-900">ミネラルウォーター 500ml</div>
                        <div className="text-sm text-gray-500">PROD-A001</div>
                      </div>
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <button
                      onClick={() => navigate('/shipment-history/customer-1?customerName=A商事株式会社')}
                      className="text-blue-600 hover:text-blue-800 hover:underline text-sm font-medium"
                    >
                      A商事株式会社
                    </button>
                    <div className="text-sm text-gray-500">東京都港区本社</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                    <div>50 c/s</div>
                    <div className="text-gray-500">1,200 本</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                    ¥120
                  </td>
                ...
                <tr className="hover:bg-gray-50">
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      <Package size={16} className="text-green-500 mr-3" />
                      <div>
                        <div className="text-sm font-medium text-gray-900">お茶 350ml</div>
                        <div className="text-sm text-gray-500">PROD-A002</div>
                      </div>
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <button
                      onClick={() => navigate('/shipment-history/customer-2?customerName=B流通株式会社')}
                      className="text-blue-600 hover:text-blue-800 hover:underline text-sm font-medium"
                    >
                      B流通株式会社
                    </button>
                    <div className="text-sm text-gray-500">大阪府大阪市本店</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                    <div>30 c/s</div>
                    <div className="text-gray-500">720 本</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                    ¥150
                  </td>
                ...
                <tr className="hover:bg-gray-50">
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      <Package size={16} className="text-purple-500 mr-3" />
                      <div>
                        <div className="text-sm font-medium text-gray-900">スポーツドリンク 500ml</div>
                        <div className="text-sm text-gray-500">PROD-A003</div>
                      </div>
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <button
                      onClick={() => navigate('/shipment-history/customer-3?customerName=Cマート')}
                      className="text-blue-600 hover:text-blue-800 hover:underline text-sm font-medium"
                    >
                      Cマート
                    </button>
                    <div className="text-sm text-gray-500">愛知県名古屋市店舗</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                    <div>40 c/s</div>
                    <div className="text-gray-500">960 本</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                    ¥180
                  </td>
                ...
                <tr className="hover:bg-gray-50">
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      <Package size={16} className="text-orange-500 mr-3" />
                      <div>
                        <div className="text-sm font-medium text-gray-900">コーヒー 250ml</div>
                        <div className="text-sm text-gray-500">PROD-A004</div>
                      </div>
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <button
                      onClick={() => navigate('/shipment-history/customer-4?customerName=D食品株式会社')}
                      className="text-blue-600 hover:text-blue-800 hover:underline text-sm font-medium"
                    >
                      D食品株式会社
                    </button>
                    <div className="text-sm text-gray-500">福岡県福岡市本社</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                    <div>20 c/s</div>
                    <div className="text-gray-500">480 本</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                    ¥200
                  </td>
                ...
                {false && <tr>
                  <td colSpan={6} className="px-6 py-12 text-center">
                    ...
                    <h3 className="mt-2 text-sm font-medium text-gray-900">製品出庫データがありません</h3>
                    <p className="mt-1 text-sm text-gray-500">製品出庫の編集から出庫情報を追加してください</p>
                  </td>
                </tr>}
