            ...
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                ...
                <tr className="hover:bg-gray-50">
                  ...
                  {dates.map((date) => {
                    const isWeekend = new Date(date).getDay() === 0 || new Date(date).getDay() === 6;
                    const sampleQuantity = isWeekend ? 0 : Math.floor(Math.random() * 180) + 120;
                    return (
                      <td key={`plan-1-${date}`} className={`px-4 py-4 whitespace-nowrap text-center ${
                  ...
                  <td className="px-4 py-4 whitespace-nowrap text-center">
                    <span className="text-sm font-medium text-gray-900">
                      {dates.reduce((sum, date) => {
                        const isWeekend = new Date(date).getDay() === 0 || new Date(date).getDay() === 6;
                        return sum + (isWeekend ? 0 : Math.floor(Math.random() * 180) + 120);
                      }, 0).toLocaleString()}
                    </span>
                  </td>
                </tr>
                ...
                <tr className="hover:bg-gray-50">
                  ...
                  {dates.map((date) => {
                    const isWeekend = new Date(date).getDay() === 0 || new Date(date).getDay() === 6;
                    const sampleQuantity = isWeekend ? 0 : Math.floor(Math.random() * 140) + 90;
                    return (
                      <td key={`plan-2-${date}`} className={`px-4 py-4 whitespace-nowrap text-center ${
                        isWeekend ? 'bg-gray-50' : ''
                      }`}>
                        <span className="text-sm font-medium text-gray-900">
                          {sampleQuantity.toLocaleString()}
                  ...
                  <td className="px-4 py-4 whitespace-nowrap text-center">
                    <span className="text-sm font-medium text-gray-900">
                      {dates.reduce((sum, date) => {
                        const isWeekend = new Date(date).getDay() === 0 || new Date(date).getDay() === 6;
                        return sum + (isWeekend ? 0 : Math.floor(Math.random() * 140) + 90);
                      }, 0).toLocaleString()}
                    </span>
                  </td>
                </tr>
                ...
                <tr className="hover:bg-gray-50">
                  ...
                  {dates.map((date) => {
                    const isWeekend = new Date(date).getDay() === 0 || new Date(date).getDay() === 6;
                    const sampleQuantity = isWeekend ? 0 : Math.floor(Math.random() * 100) + 70;
                    return (
                      <td key={`plan-3-${date}`} className={`px-4 py-4 whitespace-nowrap text-center ${
                        isWeekend ? 'bg-gray-50' : ''
                      }`}>
                        <span className="text-sm font-medium text-gray-900">
                          {sampleQuantity.toLocaleString()}
                  ...
                  <td className="px-4 py-4 whitespace-nowrap text-center">
                    <span className="text-sm font-medium text-gray-900">
                      {dates.reduce((sum, date) => {
                        const isWeekend = new Date(date).getDay() === 0 || new Date(date).getDay() === 6;
                        return sum + (isWeekend ? 0 : Math.floor(Math.random() * 100) + 70);
                      }, 0).toLocaleString()}
                    </span>
                  </td>
                </tr>
                ...
                <tr className="hover:bg-gray-50">
                  ...
                  {dates.map((date) => {
                    const isWeekend = new Date(date).getDay() === 0 || new Date(date).getDay() === 6;
                    const sampleQuantity = isWeekend ? 0 : Math.floor(Math.random() * 80) + 50;
                    return (
                      <td key={`plan-4-${date}`} className={`px-4 py-4 whitespace-nowrap text-center ${
                        isWeekend ? 'bg-gray-50' : ''
                      }`}>
                        <span className="text-sm font-medium text-gray-900">
                          {sampleQuantity.toLocaleString()}
                  ...
                  <td className="px-4 py-4 whitespace-nowrap text-center">
                    <span className="text-sm font-medium text-gray-900">
                      {dates.reduce((sum, date) => {
                        const isWeekend = new Date(date).getDay() === 0 || new Date(date).getDay() === 6;
                        return sum + (isWeekend ? 0 : Math.floor(Math.random() * 80) + 50);
                      }, 0).toLocaleString()}
                    </span>
                  </td>
                </tr>
